    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('scheduler_type', models.CharField(blank=True, choices=[('once', 'Once'), ('daily', 'Daily'), ('weekly', 'Weekly'), ('monthly', 'Monthly'), ('monthly_last_day', 'Monthly last day')], max_length=24, null=True, verbose_name='scheduler_type')),
